...
def get_params():
  ...
  parser.add_argument("--decode_vocab_sizes", type=str, default="95000,95000,95000",
  ...
  parser.add_argument("--model_path", type=str, default="",
                      help="Model exact path", required=False)


  params = parser.parse_args()

  params.src_lang=params.direction.split("-")[0]
  params.trg_lang=params.direction.split("-")[1]
...
if __name__ == "__main__":
  ...
  assert params.src_lang in ["en", "zh", "fr","en2zh", "zh2en","en2fr","fr2en","zh2fr","fr2zh"]
  assert params.trg_lang in ["en", "zh","fr"]
