...
def get_params():
    ...
    parser.add_argument("--decode_vocab_sizes", type=str, default="26000,20000,26000",
    ...
    # remote debug
    parser.add_argument("--remote_debug", type=bool_flag, default=False,
                        help="remote Debug with pycharm")
