...
PRETRAINED_MODEL_ARCHIVE_MAP = {
    ...
    'bert-base-cased': "http://localhost:8000/models.huggingface.co/bert/bert-base-cased.tar.gz",
    'bert-large-cased': "http://localhost:8000/models.huggingface.co/bert/bert-large-cased.tar.gz",
    'bert-base-multilingual-uncased': "http://localhost:8000/models.huggingface.co/bert/bert-base-multilingual-uncased.tar.gz",
    'bert-base-multilingual-cased': "http://localhost:8000/models.huggingface.co/bert/bert-base-multilingual-cased.tar.gz",
    'bert-base-chinese': "http://localhost:8000/models.huggingface.co/bert/bert-base-chinese.tar.gz",
}
